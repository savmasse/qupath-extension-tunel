 ...
 *
 */
public class BrightnessContrastCommandCopy implements PathCommand, ImageDataChangeListener<BufferedImage>, PropertyChangeListener {
...
//	private float maxCurrent = 0;
	...
	public BrightnessContrastCommandCopy(final QuPathGUI qupath) {
		this.qupath = qupath;
